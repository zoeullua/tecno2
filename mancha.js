class Mancha {
    ...
    dibujar() {
      ...
      if (mouseX > 334) {
        ...
        this.pgNegras.image(this.grandes[cualgrandes], random(-100, 500), random(-100, 450), 350, 350);
      }
      ...
      // e/ 167 y 334 = manchas grises.
        ...
        this.pgGrises.image(this.grises[cualgrises], random(-100, 500), random(-100, 450), 300, 300, 80);
      }
    }
